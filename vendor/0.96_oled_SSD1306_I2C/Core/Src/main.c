...
void SystemClock_Config(void)
{
  ...
  RCC_OscInitStruct.PLL.PLLMUL = RCC_PLL_MUL6;    // Adjust this for your needed frequency
...
{
  hi2c1.Instance = I2C1;
  hi2c1.Init.Timing = 0x2000090E;  // This timing value is for 400kHz with 48MHz clock
